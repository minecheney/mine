package com.cheney.manage.security.util;

import cn.hutool.core.date.DateUtil;
import cn.hutool.core.util.StrUtil;
import com.cheney.common.common.Consts;
import com.cheney.common.common.Status;
import com.cheney.common.exception.SecurityException;
import com.cheney.manage.security.config.JwtConfig;
import com.cheney.manage.security.vo.UserPrincipal;
...
public class JwtUtil {
    ...
    public String createJWT(Boolean rememberMe, Long id, String subject, List<String> roles, Collection<? extends GrantedAuthority> authorities) {
        ...
        stringRedisTemplate.opsForValue()
                .set(Consts.REDIS_JWT_KEY_PREFIX + subject, jwt, ttl, TimeUnit.SECONDS);
        return jwt;
    }
